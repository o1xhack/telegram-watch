...
## 1.8.1 — 2026-08-24
- Prevent unrelated SQLite files from disabling Full Archive capture by recognizing only canonical archive shard paths, while preserving fail-closed handling for genuine orphaned shards and showing actual archive runtime health in the daemon heartbeat and GUI.
